hostapd_set_bss_options() {
	...
	config_get supported_rates "$device" supported_rates
	[ -n $supported_rates ] && supported_rates="10 20 55 110 60 90 120 180 240 360 480 540"
	append "$var" "supported_rates=$supported_rates" "$N"
