#ifndef _SPI_8972D_H_
#define _SPI_8972D_H_
...
//extern void _rtl8972D_init_spi_channels(int size, struct rtl_spi_dev_s* pDev[], uint32 pin_cs[], uint32 pin_reset, uint32 pin_clk, uint32 pin_do, uint32 pin_di);
extern int32 __rtl8972D_spi_init( struct rtl_spi_dev_s* pDev, uint32 gpioSCLK, uint32 gpioCS_, uint32 gpioSDO, uint32 gpioSDI, int32 gpioINT);
#define _rtl8972D_spi_init( dev, clk, cs, do, di )	__rtl8972D_spi_init( dev, clk, cs, do, di, 0 )
#define _rtl8972D_spi_init_ex( dev, clk, cs, do, di, int )	__rtl8972D_spi_init( dev, clk, cs, do, di, int )
