...
#define SPI_DEV_NUM	3	// this means total SPI interface set number
#define SLIC0_SPI_DEV	0	// this means SLIC use SPI set 0 (SLIC use daisy chain SPI)
#define SLIC1_SPI_DEV	-1	
#define DAA0_SPI_DEV	1	// this means DAA port 0 use SPI set 1
#define DAA1_SPI_DEV	2	// this means DAA port 1 use SPI set 2
