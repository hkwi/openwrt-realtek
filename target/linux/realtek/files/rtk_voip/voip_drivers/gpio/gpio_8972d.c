...
/*
@func int32 | _rtl8972D_initGpioPin | Initiate a specifed GPIO port.
...
/*
@func int32 | _rtl8972D_getGpioDataBit | Get the bit value of a specified GPIO ID.
...
/*
@func int32 | _rtl8972D_setGpioDataBit | Set the bit value of a specified GPIO ID.
@parm uint32 | gpioId | GPIO ID
...
/*
@func uint32 | _init_GpioShare_setting | init rtl 8972D revision GPIO registers
@rvalue int | val | 0:success; otherwise fail
@comm
init rtl 8972D GPIO registers in GpioShare_setting table
default value is used for rtl 8972D revision B 
*/
