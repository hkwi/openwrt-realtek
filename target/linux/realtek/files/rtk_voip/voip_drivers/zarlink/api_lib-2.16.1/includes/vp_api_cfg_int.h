...
/*
 * When NOT using Legacy Ringing Detection, #undef this when using CPC5621
...
/* Default setting for debug messages option */
//#define VP_OPTION_DEFAULT_DEBUG_SELECT          0x00000000
